#!/usr/bin/python3
"""Outlines all unittests for models/city.py.
...
class TestCity_instantiation(unittest.TestCase):
    """Defines instantiation Unittests of the City class."""
...
class TestCity_save(unittest.TestCase):
    """Defines save method Unittests of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """Defines to_dict method Unittests of the City class."""
